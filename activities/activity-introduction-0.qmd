...
Import all relevant sources into Zotero and [create a dedicated collection](activity-introduction-99.qmd) for this module.
...
::: {.callout-note}
## Further comparison of reference management tools

A more detailed comparison of reference management programs is provided by the Technical University of Munich Library:

[Reference management programmes in test – TUM University Library](https://www.ub.tum.de/en/news/reference-management-programmes-test)
